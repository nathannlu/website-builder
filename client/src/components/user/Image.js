...
export const Image = ({opacity, background, width = '100%', children, src}) => {
	const { connectors: {connect,drag} } = useNode();
  return (
		<img style={{opacity, width, background, minHeight: '48px'}} className="min-h-full" src={src} ref={ref => connect(drag(ref))} />
  )
}
