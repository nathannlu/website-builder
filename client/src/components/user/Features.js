...
export const Features = () => {
	...
	return (
		<div style={{padding: '40px'}} className="relative" ref={ref=>connect(drag(ref))}>
			<div className="text-center">
				<Text fontSize={24} fontFamily="Times" fontWeight="bold" text="How can I help you?" />
			</div>
			<div className="flex flex-wrap">
				<div class="w-full md:w-1/2 pb-24 px-8 text-center">
					...
					<Text fontSize={20} fontFamily="Times" fontWeight="bold" text="I want to sell my home" />
					<Text fontSize={16} text="Buying is a huge decision. Whether you are a first time home buyer, purchasing your second or third, or investing in a vacation property, we understand that it’s hard to find a place you can truly call “home”." />
				...
				<div class="w-full md:w-1/2 pb-16 px-8 text-center">
					...
					<Text fontSize={20} fontFamily="Times" fontWeight="bold" text="I want to sell my home" />
					<Text fontSize={16} text="Selling a home is tough, but it shouldn’t be a chore. With the help of a good real estate agent, setting the price, preparing, and marketing the home effectively to attract buyers is easy. And it only takes one phone call." />
					<Button size="small" variant="outlined" color="primary">
						See your options
					</Button>
				</div>
